...
class Student {
  ...
  constructor(name: string,contact_number:number, fatherName: string, age: number, gender: string) {
    ...
    addStudent(name: string,contact_number:number ,fatherName: string, age: number, gender: string) {
